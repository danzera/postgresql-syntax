...
-- 3. Update all records with an account_balance of 0.00 and a transactions_attempted of 0.
...
('warren', 'omaha', 100, 101, 7610000000);

-- 9. The bank is losing money in Miami and Phoenix and needs to unload low transaction customers.
SELECT username, city, transactions_completed FROM syntax_practice
